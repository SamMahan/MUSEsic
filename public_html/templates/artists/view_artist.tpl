...
<body>
    ...
    <div class="row">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>00:30:00</td>
                    <td>10/20/06</td>
                    <td><button type="button" class="btn btn-danger">Remove From Artist</button></td>
                </tr>
                <tr>
                    <td>2</td>
        ...
        <div class="row">
            <div class="col-lg-11"></div>
            <div class="col-lg-1">
                <a href="/public_html/templates/Albums/TEMP_addalbum.html" class="btn btn-success">Add Album To Artist</a>
            </div>
        </div>
